...
import com.devfelipe.transparencyportal.assignment.resource.hateoas.AssignmentHateoasService;
...
public class AssignmentController extends BaseController<Assignment, Integer, AssignmentRequestDto, AssignmentResponseDto, AssignmentSpecification> {
    protected AssignmentController(final AssignmentService assignmentService, final AssignmentHateoasService assignmentHateoasService) {
        super(assignmentService, assignmentHateoasService);
    }
}
